...
from ChinaMM_model_train_drcan import  T_CNN
from utils import (
  imsave,
  prepare_data
)
...
flags = tf.app.flags
flags.DEFINE_integer("epoch", 100, "Number of epoch [200]")
...
flags.DEFINE_string("checkpoint_dir", "checkpoint_UIEB", "Name of checkpoint directory [checkpoint]")
