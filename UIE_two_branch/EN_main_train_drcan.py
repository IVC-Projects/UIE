...
from EN_model_train_drcan import  T_CNN
from utils import (
  imsave,
  prepare_data
)
...
flags = tf.app.flags
flags.DEFINE_integer("epoch", 600, "Number of epoch [200]")
...
flags.DEFINE_float("learning_rate", 0.001,"The learning rate of gradient descent algorithm [1e-3]")  # After 200 epoches, lr=0.0005
flags.DEFINE_float("beta1", 0.5, "Momentum term of adam [0.5]")
flags.DEFINE_integer("c_dim", 3, "Dimension of image color. [3]")
flags.DEFINE_string("checkpoint_dir", "20210826_01_lzksnetwork_CHECKPOINT_use_EUVP2000_No2_Branch", "Name of checkpoint directory [checkpoint]")
